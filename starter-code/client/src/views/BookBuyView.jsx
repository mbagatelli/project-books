...
export default class BookBuyView extends Component {
  ...
  handleRequestBook() {
    sellerBuyNotification(this.state.book._id, this.state.fullName, this.state.address);
  }
      ...
      <div>
        ...
        <Collapse in={!this.state.isCollapsed}>
          <Card.Text className="m-3" id="address">
                ...
                <Form onSubmit={this.handleFormSubmit}>
                  <Form.Row>
                    <Form.Group as={Col} controlId="formGridEmail">
                      ...
                      <Form.Control type="text" name="fullName" placeholder={this.state.fullName} onChange={this.handleOnChange}/>
                    </Form.Group>
                  </Form.Row>
                  ...
                  <Form.Row>
                    <Form.Group as={Col} controlId="formGridAddress1">
                      ...
                      <Form.Control type="text" name="address" placeholder={this.state.address} onChange={this.handleOnChange}/>
                    </Form.Group>
                  </Form.Row>
            ...
            <Button variant="secondary" className="m-3" onClick={() => this.toggleCollapse()}
